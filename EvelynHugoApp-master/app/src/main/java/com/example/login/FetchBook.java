...
public class FetchBook extends AsyncTask<String,Void,String>{
    ...
    public FetchBook(TextView titleText, TextView authorText, EditText bookInput, TextView descriptionText, TextView dataText, TextView buyText) {
        this.mTitleText = titleText;
        this.mAuthorText = authorText;
        this.mBookInput = bookInput;
        this.mDescriptionText = descriptionText;
        this.mdataText = dataText;
        this.mbuyText = buyText;
    }
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            while (i < itemsArray.length() || (authors == null && title == null && description == null && publisher== null && pdf == null)) {
            ...
            if (title != null && authors != null){
                mTitleText.setText("Titulo: " + title);
                mAuthorText.setText("Autor(a): " +authors);
                mBookInput.setText("");
                mDescriptionText.setText("Descrição: " +description);
                mdataText.setText("Editora: " + publisher);
                mbuyText.setText(pdf);
            } else {
